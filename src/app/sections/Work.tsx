...
const experiences = [
  {
    ...
    bullets: [
      ...
      "Designed and launched custom merch lines, apparel, home decor, accessories by using Adobe Illustrator and Photoshop, managing a full creative pipeline from concept to sale.",
      ...
      "Operated as sole creative director: ideation, design, production, and analytics end to end.",
    ],
  },
  {
    id: "02",
    role: "YZY App Developer & Marketing Lead",
    company: "Yeezy",
  ...
  return (
    <section id="work" className="border-b border-neutral-900 bg-white">
      ...
      <div className="grid grid-cols-4 border-b border-neutral-200 text-[9px] font-mono uppercase tracking-widest">
        <div className="p-3 border-r border-neutral-200">02</div>
        <div className="p-3 border-r border-neutral-200">Work Experience</div>
        <div className="p-3 border-r border-neutral-200"></div>
        <div className="p-3">Design, dev & strategy</div>
      </div>

      {/* Intro */}
      <div className="grid grid-cols-1 md:grid-cols-2 border-b border-neutral-200">
        <div className="p-12 md:p-24 border-b md:border-b-0 md:border-r border-neutral-200 flex items-center">
          <Reveal>
        ...
        <div className="p-12 md:p-24 flex flex-col justify-between">
          ...
          <div className="max-w-xs mt-12">
            <span className="font-mono text-[9px] uppercase tracking-widest text-neutral-500 block mb-2">Roles</span>
            <p className="font-serif text-lg leading-snug">
              Brand design, product development, and full-stack engineering across agencies and in-house teams.
            </p>
          </div>
        </div>
      </div>
              ...
              <div className="p-6 md:p-8">
                ...
                <ul className="space-y-2">
                  {exp.bullets.map((bullet, i) => (
                    <li key={i} className="font-serif text-base leading-relaxed text-neutral-600 flex gap-2">
