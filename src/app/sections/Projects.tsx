...
export function Projects() {
	return (
		<section id="projects" className="border-b border-neutral-900 bg-white">
			<SectionBar
				cols={['03', 'Selected Projects', 'Full Stack & Design', '2024–2025']}
			/>

			<div className="flex flex-col gap-6 border-b border-neutral-200 p-6 md:flex-row md:items-end md:justify-between md:p-12">
				...
				<a
					href="https://shazport.netlify.app/"
					target="_blank"
					rel="noreferrer"
					className="inline-flex items-center self-start border border-neutral-300 bg-white px-5 py-3 font-mono text-[11px] uppercase tracking-[0.25em] text-neutral-700 transition-colors duration-300 hover:border-neutral-900 hover:bg-neutral-900 hover:text-white md:self-end"
				>
					Portfolio Site
